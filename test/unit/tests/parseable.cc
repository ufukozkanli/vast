...
TEST(binary) {
  ...
  auto l = f + 1;
  auto u8 = uint8_t{0};
  CHECK(be8.parse(f, l, u8));
  CHECK(u8 == 0x01);
  CHECK(f == l);
  f = str.begin();
  l = f + 2;
  auto u16 = uint16_t{0};
  CHECK(be16.parse(f, l, u16));
  CHECK(u16 == 0x0102);
  CHECK(f == l);
  f = str.begin();
  l = f + 4;
  auto u32 = uint32_t{0};
  CHECK(be32.parse(f, l, u32));
  CHECK(u32 == 0x01020304);
  CHECK(f == l);
  f = str.begin();
  l = f + 8;
  auto u64 = uint64_t{0};
  CHECK(be64.parse(f, l, u64));
  ...
  f = str.begin();
  l = f + 1;
  CHECK(le8.parse(f, l, u8));
  CHECK(u8 == 0x01);
  CHECK(f == l);
  f = str.begin();
  l = f + 2;
  CHECK(le16.parse(f, l, u16));
  CHECK(u16 == 0x0201);
  CHECK(f == l);
  f = str.begin();
  l = f + 4;
  CHECK(le32.parse(f, l, u32));
  CHECK(u32 == 0x04030201);
  CHECK(f == l);
  f = str.begin();
  l = f + 8;
  CHECK(le64.parse(f, l, u64));
